...
export default {
  ...
  xSmallMargin: heightRatio(5),
  smallMargin: heightRatio(8),
  mediumMargin: heightRatio(12),
  ...
  radius: {
    small: heightRatio(5),
    medium: heightRatio(15),
    large: heightRatio(20),

    xLarge: heightRatio(40),
  },
  ...
  images: {
    ...
    sMedium: heightRatio(30),
    lMedium: heightRatio(32),
